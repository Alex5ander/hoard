...
export class TypesOfFinancialReservePage implements OnInit {
  contents = [
    ...
    },
    {
      ...
      content:
        'Ter alguma reserva é algo importante, não só em casos de desemprego, mas também em caso de situações que muitas vezes não esperamos, e podemos ser pegos de surpresa, então por isso comece hoje uma reserva, de 1, 2 ou 4 meses dependendo de suas necessidades.',
    },
  ];
